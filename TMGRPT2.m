...
HOMEBPS(BDATE,DATAARR)  ;  
  ...
  . . . . SET SYSSTR="3077F"
  . . . IF SYSSTR'="" DO
  . . . . IF $$HASCPT^TMGRPU1(TMGDFN,SYSSTR,$P(DATE,".",1),$P(DATE,".",1)) QUIT ;"SET SYSSTR=SYSSTR_" (ALREADY REPORTED)"
  ...
  . . . . SET DIASTR="3079F"
  . . . IF DIASTR'="" DO
  . . . . IF $$HASCPT^TMGRPU1(TMGDFN,DIASTR,$P(DATE,".",1),$P(DATE,".",1)) QUIT ;"SET DIASTR=DIASTR_" (ALREADY REPORTED)"
...
TSKNOADD  ;"
  ...
  NEW TIUIEN SET TIUIEN=0
  NEW SIGNEDARR,UNSIGNEDARR,OLDARR
  NEW CUTOFFDT
  SET CUTOFFDT=$$ADDDAYS^TMGDATE("-14")
  ...
  . . ELSE  DO
  . . . IF NOTEDATE<CUTOFFDT DO
  . . . . SET OLDARR(ADDLUSER,PATIENT,NOTEDATE)=""
  . . . ELSE  DO
  ...
  WRITE "************************************************************",!,!
  IF $D(OLDARR) DO
  . WRITE " ====ALERTS OLDER THAN 14 DAYS====",!
  . NEW USER SET USER=0
  . FOR  SET USER=$O(OLDARR(USER)) QUIT:USER=""  DO
  . . WRITE "USER: ",$P($G(^VA(200,USER,0)),"^",1),!
  . . NEW PATIENT SET PATIENT=""
  . . FOR  SET PATIENT=$O(OLDARR(USER,PATIENT)) QUIT:PATIENT=""  DO
  . . . NEW DATES SET DATES=""
  . . . NEW ONEDATE SET ONEDATE=""
  . . . FOR  SET ONEDATE=$O(OLDARR(USER,PATIENT,ONEDATE)) QUIT:ONEDATE=""  DO
