...
LMAPAPI2(TMGENV,NLT,OUT) ;"GATHER NATIONAL LABORATORY TEST (NLT) MAPPING.
        ...
        ;"          OUT(NLT,"DEBUG",#,#)=<text to help with debugging>
        ;"Result: 1 if OK, or 0^Message of mapping problem, or -1^Step#^Message if error.
        NEW TMGRESULT SET TMGRESULT=1
        NEW IEN62D4 SET IEN62D4=TMGENV("IEN 62.4")
        KILL OUT
        ...
        NEW DBGIDX SET DBGIDX=+$ORDER(OUT(NLTP1,"DEBUG",2,""))
        ...
        . SET DBGIDX=DBGIDX+1,OUT(NLTP1,"DEBUG",2,DBGIDX)="IEN64 from ^LAM(""C"","_NLTP1_"*,  $ORDER LOOP"
        . SET DBGIDX=DBGIDX+1,OUT(NLTP1,"DEBUG",2,DBGIDX)="IEN64 #"_IEN64_" = "_NAME
        ...
        . SET DBGIDX=DBGIDX+1,OUT(NLTP1,"DEBUG",2,DBGIDX)="AUTO INSTRUMENT TEST NAME = "_TESTNAME
        . SET DBGIDX=DBGIDX+1,OUT(NLTP1,"DEBUG",2,DBGIDX)="AUTO INSTRUMENT TEST FROM $$GET1^DIQ(62.41,IENS,.01), IENS='"_IENS_","
        . SET OUT(NLTP1,"AUTO INSTRUMENT TEST")=IENS_"^"_TESTNAME
        . NEW STORAGE SET STORAGE=$$GET1^DIQ(62.41,IENS,11)
        . SET DBGIDX=DBGIDX+1,OUT(NLTP1,"DEBUG",2,DBGIDX)="STORAGE='"_STORAGE_"', from: $$GET1^DIQ(62.41,IENS,11), IENS='"_IENS_"," 
        . SET OUT(NLTP1,"IEN 60")=$$GET1^DIQ(62.41,IENS,.01,"I")
        . SET DBGIDX=DBGIDX+1,OUT(NLTP1,"DEBUG",2,DBGIDX)="IEN 60='"_OUT(NLTP1,"IEN 60")_"', from: $$GET1^DIQ(62.41,IENS,.01,'I'), IENS='"_IENS_"," 
        ...
        . . SET DBGIDX=DBGIDX+1,OUT(NLTP1,"DEBUG",2,DBGIDX)="STORAGE NAME='"_NAME_"', from $GET(^DD(63.04,FIELD,0)), FIELD="_FIELD_","   
        . ELSE  DO
        ...
        . SET DBGIDX=DBGIDX+1,OUT(NLTP1,"DEBUG",2,DBGIDX)="Storage source: File AUTO INSTRUMENT (#62.4) `"_IEN62D4_", multiple-field CHEM TESTS (#62.41) `"_IEN62D41
        IF COUNT=0 DO  GOTO VMA2DN
