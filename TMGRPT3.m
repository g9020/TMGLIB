...
CPEREPORT
  ...
  . . IF (REASON="PHYSICAL")!(REASON["1 YR") DO
  ...
  ;"
  ;"   ADDING ANOTHER CHECK FOR APPTS > 365
  SET SDT=$$ADDDAYS^TMGDATE(366),EDT=$$ADDDAYS^TMGDATE(2000)
  ;"
  K APPTARRAY
  DO APPT4DT^TMGSMS05(SDT,EDT,.APPTARRAY,1)
  NEW APPTDATE SET APPTDATE=0
  ...
  . . NEW REASON SET REASON=$G(APPTARRAY(APPTDATE,TMGDFN,"REASON"))
  . . NEW PTNAME SET PTNAME=$G(APPTARRAY(APPTDATE,TMGDFN,"NAME"))
  . . IF REASON["MO" DO  QUIT
  . . . SET OUTARRAY("THESE APPOINTMENTS MAY BE TOO FAR IN THE FUTURE",PTNAME,REASON_" MADE FOR "_$$EXTDATE^TMGDATE(APPTDATE))=""
  . . NEW PROVIDER SET PROVIDER=$G(APPTARRAY(APPTDATE,TMGDFN,"PROV"))
  . . IF PROVIDER=83 SET OUTARRAY("THESE APPOINTMENTS MAY BE TOO FAR IN THE FUTURE",PTNAME,REASON_" MADE FOR "_$$EXTDATE^TMGDATE(APPTDATE))=""
  ;"
  NEW %ZIS
  SET %ZIS("A")="Enter Output Device: "
  SET IOP="S121-LAUGHLIN-LASER"
